...
const userSchema = new mongose.Schema({
    ...
    MemberType:{
        type:String, // This must be = [General,Special,ExtraSpecial]
    },
    Name:{
        type:String
    },
    ...
    JoiningDate:{ // in this format 10-10-2022 format mm-DD-yyyyy
        type:String,
    },
    LoanStatus:{
...
module.exports = SUser = mongose.model("SUser",userSchema);

// first time 1000 and every month 100